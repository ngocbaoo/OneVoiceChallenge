...
1. [MOS — Mean Opinion Score](#1-mos--mean-opinion-score)
2. [PESQ — Perceptual Evaluation of Speech Quality](#2-pesq--perceptual-evaluation-of-speech-quality)
3. [STOI — Short-Time Objective Intelligibility](#3-stoi--short-time-objective-intelligibility)
4. [MCD — Mel-Cepstral Distortion](#4-mcd--mel-cepstral-distortion)
5. [WER — Word Error Rate (trong ngữ cảnh TTS)](#5-wer--word-error-rate-trong-ngữ-cảnh-tts)
6. [Speaker Similarity — Cosine Similarity](#6-speaker-similarity--cosine-similarity)
7. [UTMOS — Predicted MOS](#7-utmos--predicted-mos)
8. [FAD — Fréchet Audio Distance](#8-fad--fréchet-audio-distance)
9. [Bảng tổng hợp](#bảng-tổng-hợp)
10. [Danh mục tài liệu tham khảo](#danh-mục-tài-liệu-tham-khảo)
...
- **[1]** FutureBeeAI (2026). *"MOS Score for TTS Models: What is Considered Good?"* — Xác nhận MOS ≥ 4.0 là "good", ≥ 4.5 cho audiobook narration, ≥ 3.5 cho virtual assistants. Tác giả cảnh báo MOS chỉ là "surface-level signal" và không chẩn đoán được lỗi cụ thể. Nguồn: [futurebeeai.com](https://www.futurebeeai.com/knowledge-hub/mos-score-tts-models)

- **[2]** Zilliz (2025). *"What are the standard evaluation metrics for TTS quality?"* — MOS 4.0 chỉ ra near-human quality, 2.5 cho thấy noticeable artifacts, ≥ 3.5 cho conversational agents. Nguồn: [zilliz.com](https://zilliz.com/ai-faq/what-are-the-standard-evaluation-metrics-for-tts-quality)

- **[3]** Thiomi Dataset (arXiv:2603.29244) — *"MOS scores above 4.0 are generally considered natural-sounding; scores of 3.5–4.0 indicate acceptable quality with noticeable artifacts; scores below 3.5 suggest significant room for improvement."* Nguồn: [arxiv.org/pdf/2603.29244](https://arxiv.org/pdf/2603.29244)

- **[4]** WellSaid Labs (2026). *"Defining Naturalness as Primary Driver for Synthetic Voice Quality"* — Bảng Likert 0.5-step chi tiết từ 1 (Bad) đến 5 (Excellent). Nguồn: [wellsaid.io](https://www.wellsaid.io/resources/blog/naturalness-primary-driver-synthetic-voice)

- **[5]** BnTTS (arXiv:2502.05729) — Bảng đánh giá 5 điểm với fractional scoring (1.5, 2.5, 3.5, 4.5) cho TTS evaluation, bao gồm các khía cạnh: Clarity, Fluency, Consistency, Emotional Expressiveness. Nguồn: [arxiv.org/pdf/2502.05729](https://arxiv.org/pdf/2502.05729)

- **[6]** Data Processing for Vietnamese TTS (arXiv:2004.09607) — End-to-end TTS cho tiếng Việt đạt MOS 4.1 so với giọng tự nhiên MOS 4.3. Nguồn: [arxiv.org/pdf/2004.09607](https://arxiv.org/pdf/2004.09607)
...
- **[8]** RF Wireless World. *"PESQ Score: Evaluating Speech Quality in GSM Networks"* — Bảng ngưỡng: 1.0–1.9 Poor, 2.0–2.9 Fair, 3.0–3.9 Good, 4.0–4.5 Excellent. GSM networks nhắm PESQ ≥ 3. Nguồn: [rfwireless-world.com](https://www.rfwireless-world.com/test-and-measurement/pesq-score-evaluating-speech-quality-in-gsm-networks)

- **[9]** Rix et al. (2001). *"Perceptual Evaluation of Speech Quality (PESQ)"*, ITU-T P.862. Bài gốc định nghĩa PESQ, thang −0.5 đến 4.5. Nguồn: [researchgate.net](https://www.researchgate.net/publication/3908525)

- **[10]** US Patent 7327985. *"Mapping objective voice quality metrics to a MOS domain"* — Công thức chuyển đổi PESQ raw → MOS-LQO, trong đó: MOS 5.0 = Excellent, 4.0 = Good, 3.0 = Fair, 2.0 = Poor, 1.0 = Bad. Nguồn: [USPTO](https://image-ppubs.uspto.gov/dirsearch-public/print/downloadPdf/7327985)

- **[11]** Kolbæk et al. (arXiv:1808.10620). *"Single-Microphone Speech Enhancement and Separation Using Deep Learning"* — PESQ được thiết kế để xấp xỉ MOS, thang từ 1 (bad, annoying) đến 5 (excellent, imperceptible distortions). Nguồn: [arxiv.org/pdf/1808.10620](https://arxiv.org/pdf/1808.10620)
...
- **[12]** Taal et al. (2011). *"An Algorithm for Intelligibility Prediction of Time–Frequency Weighted Noisy Speech"*, IEEE Trans. Audio, Speech, Lang. Process. — Bài gốc định nghĩa STOI, thang 0–1, tương quan 0.9+ với intelligibility scores từ con người. Giọng sạch đạt mean STOI = 1.00, giọng nhiễu mean = 0.85. Nguồn: [researchgate.net/figure](https://www.researchgate.net/figure/Performance-of-STOI-compared-with-five-other-reference-objective-intelligibility-models_fig8_224219052)

- **[13]** MathWorks. *"Measuring Speech Intelligibility and Perceived Audio Quality with STOI and ViSQOL"* — Thang lý thuyết [−1, 1], thực tế [0.4, 1]. *"When the STOI metric approaches 0.4 the speech approaches unintelligibility."* Nguồn: [mathworks.com](https://www.mathworks.com/help/audio/ug/measure-speech-intelligibility-and-perceived-audio-quality-with-stoi-and-visqol.html)

- **[14]** CallShield (arXiv/ResearchGate, 2025) — Hệ thống đạt PESQ > 4.2 và STOI > 0.94 trên clean speech, chứng minh STOI > 0.94 là mức chất lượng cao cho ứng dụng thực tế. Nguồn: [researchgate.net](https://www.researchgate.net/figure/Scatter-plots-between-STOI-and-the-speech-intelligibility-scores-from-three-different_fig5_224219052)

- **[15]** Picovoice (2024). *"Measuring Speech Intelligibility"* — STI/SII/STOI thang 0–1 trong đó 0 = bad, 1 = excellent. STOI được chọn vì tương quan cao với speech intelligibility trong kiểm thử chủ quan. Nguồn: [picovoice.ai/blog/speech-intelligibility](https://picovoice.ai/blog/speech-intelligibility/)
...
- **[16]** Survey TTS toàn diện (arXiv:2412.06602). *"Towards Controllable Speech Synthesis in the Era of Large Language Models"* — *"Typically, an MCD value below 4 suggests good quality, while values above 6 may indicate significant distortion."* Nguồn: [arxiv.org/pdf/2412.06602](https://arxiv.org/pdf/2412.06602)

- **[17]** Kominek et al. (2008). *"Synthesizer voice quality of new languages calibrated with mean mel cepstral distortion"* — Bài gốc đề xuất MCD làm metric hiệu chuẩn chất lượng TTS đa ngôn ngữ. Được trích dẫn trong [learnius.com](https://learnius.com/slp/9+Speech+Synthesis/1+Fundamental+Concepts/3+Evaluation/mel+cepstral+distortion+(MCD)).

- **[18]** Zilliz (2025). *"What are the standard evaluation metrics for TTS quality?"* — *"Lower MCD values (e.g., 6 dB vs. 10 dB) indicate better alignment with the reference speech."* Nguồn: [zilliz.com](https://zilliz.com/ai-faq/what-are-the-standard-evaluation-metrics-for-tts-quality)

- **[19]** Zero-shot TTS cho tiếng Ấn Độ (arXiv:2506.03884) — MCD scores thực tế: 6.94–10.74 dB cho zero-shot cross-lingual TTS (low-resource), cho thấy zero-shot thường có MCD cao hơn in-domain.
...
- **[21]** Zilliz (2025). *"What are the standard evaluation metrics for TTS quality?"* — *"A WER below 5% is often required for accessibility tools like screen readers."* Nguồn: [zilliz.com](https://zilliz.com/ai-faq/what-are-the-standard-evaluation-metrics-for-tts-quality)

- **[22]** NVIDIA Riva. *"Evaluate a TTS Pipeline"* — Sử dụng WER threshold tùy chỉnh để phát hiện utterances chất lượng thấp. Lưu ý: *"the only way to measure the quality of TTS model is to use subjective methods such as MOS and CMOS."* Nguồn: [docs.nvidia.com](https://docs.nvidia.com/deeplearning/riva/user-guide/docs/tutorials/tts-evaluate.html)

- **[23]** Way With Words (2024). *"Word Error Rate: Assessing Transcription Service Accuracy"* — *"A word error rate of 5–10% is generally considered acceptable in most contexts."* Các lĩnh vực y tế/pháp luật yêu cầu < 5%. Nguồn: [waywithwords.net](https://waywithwords.net/resource/word-error-rate-transcription-accuracy/)

- **[24]** F5-TTS (arXiv:2410.06885) và Traceable TTS (arXiv:2507.03887) — Các model TTS state-of-the-art đạt WER ~2.0–2.2% trên LibriSpeech test-clean, cho thấy ngưỡng < 3% là mục tiêu khả thi cho model hiện đại.

- **[25]** Position paper (arXiv:2510.06927). *"Towards Responsible Evaluation for TTS"* — Phát hiện rằng tại mức WER đã thấp, việc giảm thêm WER không mang lại cải thiện nhận thức đáng kể (negligible perceptual improvement).
...
- **[26]** Zilliz (2025). *"What are the standard evaluation metrics for TTS quality?"* — *"A score of 0.8 might indicate strong resemblance to a target speaker."* Nguồn: [zilliz.com](https://zilliz.com/ai-faq/what-are-the-standard-evaluation-metrics-for-tts-quality)

- **[27]** Zero-shot voice cloning thesis (Univ. Groningen, 2025) — *"A value above 0.9 is typically indicative of very high speaker similarity for zero-shot TTS systems (Casanova et al., 2022 reported 0.86)."* Nguồn: [campus-fryslan.studenttheses.ub.rug.nl](https://campus-fryslan.studenttheses.ub.rug.nl/708/1/MAs5965055QYZhu.pdf)

- **[28]** Nepali voice cloning (arXiv:2601.18694) — Phân loại rõ ràng: *"Excellent (≥ 0.95), Good (≥ 0.90), Fair (≥ 0.85)"*. Mean similarity 0.904 trên 10 speakers. Nguồn: [arxiv.org/pdf/2601.18694](https://arxiv.org/pdf/2601.18694)

- **[29]** Speaker verification research (ResearchGate) — *"cosine similarity score of about 0.6 is a good threshold to distinguish whether the two utterances belong to the same speaker."* Nguồn: [researchgate.net](https://www.researchgate.net/figure/The-distribution-of-cosine-similarity-of-speaker-embeddings-in-three-conditions_fig3_360792905)

- **[30]** NeuTTS Air (Medium, 2025) — *"With 3s references, speaker similarity reaches 85–90%; improves to 95%+ with 15s inputs."* Nguồn: [medium.com](https://medium.com/data-science-in-your-pocket/neutts-air-revolutionizing-on-device-text-to-speech-with-instant-voice-cloning-df3aadebc5cc)
...
- **[31]** NVIDIA NeMo Curator. *"UTMOS Filter"* — *"Match threshold to downstream model: TTS (4.0+), ASR (3.5), permissive curation (3.0)."* UTMOS dự đoán MOS trên thang 1.0–5.0. Nguồn: [docs.nvidia.com/nemo/curator](https://docs.nvidia.com/nemo/curator/curate-audio/process-data/quality-filtering/utmos)

- **[32]** Saeki et al. (2022). *"UTMOS: UTokyo-SaruLab System for VoiceMOS Challenge 2022"* — Mô hình ensemble giành chiến thắng tại VoiceMOS Challenge 2022. Nguồn: [arxiv.org/pdf/2202.xxxxx](https://arxiv.org/abs/2202.xxxxx), được trích dẫn rộng rãi trong [33][34].

- **[33]** F5-TTS (arXiv:2410.06885) — UTMOS = 3.926 cho F5-TTS baseline trên LibriSpeech. Nguồn: [arxiv.org/pdf/2410.06885](https://arxiv.org/pdf/2410.06885)

- **[34]** Traceable TTS (arXiv:2507.03887) — F5-TTS đạt UTMOS 3.958 sau joint training, cho thấy model TTS hiện đại thường đạt UTMOS 3.9–4.2. Nguồn: [arxiv.org/pdf/2507.03887](https://arxiv.org/pdf/2507.03887)

- **[35]** Emergent Mind (2025). *"UTMOS Score"* — *"At very high subjective quality levels (e.g., MUSHRA > 80), non-intrusive measures such as UTMOS tend to saturate."* UTMOS hiệu quả nhất ở mức chất lượng thấp–trung bình. Nguồn: [emergentmind.com](https://www.emergentmind.com/topics/utmos)
...
- **[36]** Kilgour et al. (2019). *"Fréchet Audio Distance: A Reference-free Metric for Evaluating Music Enhancement Algorithms"*, Interspeech 2019. — Bài gốc đề xuất FAD. FAD trên dữ liệu không biến dạng ≈ 0.2, FAD tương quan 0.52 với đánh giá con người (cao hơn SDR 0.39). Nguồn: [isca-archive.org](https://www.isca-archive.org/interspeech_2019/kilgour19_interspeech.pdf)

- **[37]** Gudmundsson et al. (2024). *"Adapting Fréchet Audio Distance for Generative Music Evaluation"* — Cảnh báo: *"a lower distance only infers high quality if the reference set is of high quality."* FAD phụ thuộc mạnh vào embedding model và reference set. Nguồn: [arxiv.org/html/2311.01616v2](https://arxiv.org/html/2311.01616v2)

- **[38]** Adapting FAD for TTS (IEEE, 2025) — Nghiên cứu cho thấy FAD trong một số embedding spaces tương quan mạnh với đánh giá con người cho speech quality, không cần listening test data. Nguồn: [ieeexplore.ieee.org](https://ieeexplore.ieee.org/document/11264402/)
...
*Tài liệu tổng hợp ngày 22/06/2026. Các ngưỡng mang tính tham khảo và phụ thuộc vào ngôn ngữ, domain, speaker encoder, ASR model, và phương pháp tính toán cụ thể. Luôn ghi rõ cấu hình khi báo cáo kết quả.*
